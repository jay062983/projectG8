...
Then the status code for creating an emplouee is 201
...
@apijsonworkflow
  Scenario: retrieve an employee using API call
    ...
    Then the retrieved data at "employee" object matches with the data of created employee
      ...
      |philip       |  sting     |jacob          |male     |2000-05-30  |Active    |Tester     |

  @apijsonworkflowdynamic
Scenario: create an employee using API call

    Given a request is prepared to create an employee with dynamic data "philip" , "stevenson" , "jacob" , "M" , "2000-05-30" , "Active" , "Tester"
